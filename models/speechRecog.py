...
def record_audio():
    ...
    with wave.open("C:\\Users\\USER\\Desktop\\projects\\ai\\neuro2.0\\Rec-exe-diff\\audio.wav", 'wb') as wf:
    ...
    result = model.transcribe("C:\\Users\\USER\\Desktop\\projects\\ai\\neuro2.0\\Rec-exe-diff\\audio.wav", fp16=False, language='English')
    msg = result["text"]
